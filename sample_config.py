...
class Config(object):
    ...
    INDEX_URL = os.environ.get("INDEX_URL", "https://moviesdeck.michaelscofield.workers.dev")
    parent_id = os.environ.get("GDRIVE_FOLDER_ID","1JdKdtZjAbLQG8wvuL-jOVmkOopzIBb13")
