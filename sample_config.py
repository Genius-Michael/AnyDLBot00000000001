...
class Config(object):
    ...
    INDEX_URL = os.environ.get("INDEX_URL", "https://movies-deck.michaelscofield.workers.dev/")
    parent_id = os.environ.get("GDRIVE_FOLDER_ID","1E_7V34RkDw1MCgfERd4JjLbp-DZwedeY")
